...
for (let j = 0; j < inputs_2.length; j++) {
     console.assert(expected_output_2[j] == Exercise2(inputs_2[j]), `Test Case failed on Exercise 2, test ${j}!`);
}
